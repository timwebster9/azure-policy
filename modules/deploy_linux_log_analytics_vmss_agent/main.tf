...
resource "azurerm_role_assignment" "role" {
  ...
  principal_id         = azurerm_management_group_policy_assignment.policy_assignment.identity.principal_id 
}

resource "azurerm_policy_remediation" "rem" {
  name                 = "example-policy-remediation"
  scope                = azurerm_management_group_policy_assignment.policy_assignment.scope
