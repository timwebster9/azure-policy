...
METADATA
  ...
  policy_rule = file("${path.module}/deploy_log_analytics_agent/policy_defs/vmss/rules.json")
  parameters = file("${path.module}/deploy_log_analytics_agent/policy_defs/vmss/parameters.json")
}
